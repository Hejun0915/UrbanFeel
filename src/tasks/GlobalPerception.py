...
def GlobalPerception(model, model_name: str, seed: Optional[int], gpus_num: int, json_path: str, image_folder: str, output_path: str, checkpoint_path: str):
    print(image_folder)
    ...
    output_path = os.path.join(output_path, "GlobalPerception")
    ...
    for dimension in PerceptionDimensions:
        ...
        for data in tqdm(json_data):
            ...
            output_json_path = os.path.join(
                output_path, f'{model_name.split("/")[-1]}_GlobalPerception_{dimension}.json'
            )
